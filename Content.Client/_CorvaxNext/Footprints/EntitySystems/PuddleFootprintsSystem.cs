...
public sealed class PuddleFootprintsSystem : EntitySystem
{
    ...
    private void OnStepTrigger(EntityUid uid, PuddleFootprintsComponent component, ref EndCollideEvent args)
    {
        ...
        if (!_solutionContainer.TryGetSolution((uid, solutionManager), puddle.SolutionName, out var solutionEntity, out var solutions))
            return;
        ...
        _solutionContainer.RemoveEachReagent(solutionEntity.Value, 1);
    }
